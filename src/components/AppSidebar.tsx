    ...
    >
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-gradient-primary rounded-lg flex items-center justify-center shadow-soft flex-shrink-0">
            <div className="text-sm font-bold text-primary-foreground">PS</div>
          </div>
          {!isCollapsed && (
            <div>
              <h2 className="font-semibold text-foreground">Portal Sync</h2>
